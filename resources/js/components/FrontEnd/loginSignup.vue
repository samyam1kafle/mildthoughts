                        ...
                        <div class="row no-gutters">
                            <div class="col-lg-6 order-2 order-lg-1">
                                <div class="timeline-bg-content bg-img"
                                     ...
                                     style="background-image: url(&quot;assets/images/timeline/adda-timeline.jpg&quot;);">
                                ...
                                <div class="signup-form-wrapper">
                                    ...
                                    <div class="signup-inner text-center">
                                        ...
                                        <form class="signup-inner--form">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="nice-select" tabindex="0"><span
                                                            class="current">Gender</span>
                                                        <ul class="list">
                                                            <li data-value="trending" class="option selected">Gender
                                                            </li>
                                                            <li data-value="sales" class="option">Male</li>
                                                            <li data-value="sales" class="option">Female</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="nice-select" tabindex="0"><span
                                                            class="current">Age</span>
                                                        <ul class="list">
                                                            <li data-value="trending" class="option selected">Age</li>
                                                            <li data-value="sales" class="option">18+</li>
                                                            <li data-value="sales" class="option">18-</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    ...
                                                    <div class="nice-select" tabindex="0"><span
                                                        ...
                                                        <ul class="list">
                                                            <li data-value="trending" class="option selected">Country
                                                            </li>
                                                            <li data-value="sales" class="option">Bangladesh</li>
                                                            <li data-value="sales" class="option">Noakhali</li>
                                                            <li data-value="sales" class="option">Australia</li>
                                                            <li data-value="sales" class="option">China</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                            ...
                                            <h6 class="terms-condition">I have read &amp; accepted the <a href="#">terms
                                                of use</a></h6>
                                        </form>
                                    </div>
                                </div>

                        ...
                        <div class="col-lg-12">
                            <div class="secondary-menu-wrapper secondary-menu-2 bg-white">
                                ...
                                <div class="filter-menu">
                                    <button class="active" data-filter="*">Followings ({{user.followings_count}})
                                    </button>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="content-box friends-zone">
                                <div class="row mt--20 friends-list" style="position: relative; height: 1150px;">
                                    <div v-for="followings in user.followings" :key="followings.id"
                                         class="col-lg-3 col-sm-6 recently request"
                                         style="left: 0px; top: 0px;">
                                        <div class="friend-list-view">
                                            <!-- profile picture end -->
                                            <div class="profile-thumb">
                                                <router-link :to="{name: 'FrontProfile' , query: {id: followings.id}}"
                                                             tag="a"
                                                             active-class="active">
                                                    <figure class="profile-thumb-middle">
                                                        <img :src="getUserImage(followings.display_image)"
                                                             alt="profile picture">
                                                    </figure>
                                                </router-link>
                                            </div>
                                            ...
                                            <div class="posted-author">
                                                <h6 class="author">
                                                    <router-link
                                                            :to="{name: 'FrontProfile' , query: {id: followings.id}}"
                                                            tag="a"
                                                            active-class="active">{{followings.name}}
                                                    </router-link>
                                                </h6>
                                                <div v-if="!self_profile">
                                                    ...
                                                    <button disabled v-else v-show="(followings.id != auth_id)"
                                                            class="add-frnd">User Followed
                                                    </button>
                                                    <button disabled v-show="(followings.id == auth_id)"

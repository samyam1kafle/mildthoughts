    ...
    <div class="container">
        <div class="card-body">
            <ul class="nav nav-tabs" id="custom-content-above-tab" role="tablist">
                <li class="nav-item">
                    <router-link tag="a" :to="{name: 'Followers'}" class="nav-link" active-class="active"
                ...
                <li class="nav-item">
                    <router-link tag="a" :to="{name: 'Following'}" class="nav-link" active-class="active"
            ...
            <div class="tab-content" id="custom-content-above-tabContent">
                <div class="tab-pane fade active open" id="custom-content-above-home" role="tabpanel"
